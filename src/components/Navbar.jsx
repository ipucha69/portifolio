        ...
        <nav className="hidden items-center gap-8 md:flex">
          {links.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `font-mono text-xs uppercase font-mono-tag tracking-widest transition-colors ${isActive ? "text-signal" : "text-ink/60 hover:text-ink"
                }`
              }
            >
              {link.label}
          ...
          <nav className="flex flex-col gap-4 pt-4">
            {links.map((link) => (
              <NavLink
                ...
                onClick={() => setOpen(false)}
                className={({ isActive }) =>
                  `font-mono text-sm uppercase font-mono-tag tracking-widest ${isActive ? "text-signal" : "text-ink/70"
                  }`
                }
              >
                {link.label}
